...
const routes: Array<RouteRecordRaw> = [
  {
    path: "/",
    redirect: "/apps/pages/monitoring",
    ...
    children: [
      ...
      {
        path: "/apps/pages/profile-details",
        name: "apps-pages-details",
        component: () => import("@/views/apps/pages/ProfileDetails.vue"),
        meta: {
      ...
      {
        path: "/apps/pages/monitoring",
        name: "monitoring-page",
        component: () => import("@/views/apps/pages/Monitoring.vue"),
        meta: {
